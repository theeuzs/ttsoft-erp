        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HaverBalance = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginalCost = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    IpiPercent = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    IcmsPercent = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    DesiredMarginPercent = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    MinStock = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    IdealStock = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    ...
                    MercadoriaOrigem = table.Column<int>(type: "int", nullable: false),
                    CFOPPadrao = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NfceChave = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NfceNumero = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NfceEmitidaEm = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
